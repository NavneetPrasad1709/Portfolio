...
<div id="page1" onMouseMove={mouseMoving} className="h-screen p-4 bg-white">
    ...
    <div className="main-image shadow-xl p-20 shadow-gray-700 h-screen bg-cover rounded-[40px] bg-[url(https://raw.githubusercontent.com/NavneetPrasad1709/Portfolio/refs/heads/main/src/assets/mainbg2.jpg)]">
